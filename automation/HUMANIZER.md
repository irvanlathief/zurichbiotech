...
**Apply this section only when the content and the author's voice call for it**, e.g. blog posts, essays, opinion, personal writing. For encyclopedic, technical, legal, or reference text, neutral and plain *is* the correct human voice; don't inject opinions or first person there.
...
**Problem:** LLMs substitute elaborate constructions for simple copulas. Use plain "is" / "are" / "has".
...
**Problem:** LLMs force ideas into groups of three to appear comprehensive. Two or four items, or a sentence, is often more natural.


### 11. Elegant Variation (Synonym Cycling)

**Problem:** AI has repetition-penalty code causing excessive synonym substitution. If you mean "the protagonist", say "the protagonist". Don't cycle through "the main character" / "the central figure" / "the hero".
...
**Problem:** AI chatbots emphasize phrases in boldface mechanically. Use sparingly.


### 16. Inline-Header Vertical Lists

**Problem:** AI outputs lists where items start with bolded headers followed by colons. Convert to prose or plain bullets.
...
**Problem:** AI chatbots often decorate headings or bullet points with emojis. Remove unless the user explicitly asked for them.


### 19. Curly Quotation Marks

**Problem:** ChatGPT uses curly quotes ("..." and '...') instead of straight quotes ("..." and '...'). Use straight quotes in HTML and code.
...
**Problem:** Text meant as chatbot correspondence gets pasted as content. Strip it.
...
**Problem:** Overly positive, people-pleasing language. Drop it.
...
**Problem:** Over-qualifying statements. "It could potentially possibly be argued that the policy might have some effect" becomes "The policy may affect outcomes."


### 25. Generic Positive Conclusions

**Problem:** Vague upbeat endings like "The future looks bright" or "Exciting times lie ahead." Replace with a specific, falsifiable next step or cut the conclusion entirely.
...
**Problem:** LLMs often add a generic sentence after a heading as a rhetorical warm-up. It usually adds nothing.
...
- **Curly quotes alone.** Most CMSes auto-curl by default. Curly quotes only count when stacked with other tells.
